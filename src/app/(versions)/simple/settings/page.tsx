...
export default function SimpleSettingsPage() {
  ...
  const [settings, setSettings] = useState<UserSettings>({
    ...
    notificationTime: "18",
    aiSuggestions: true,
    aiLevel: 50,  // Default für einfache Version: mittlerer Unterstützungsgrad
    analytics: true,
    twoFactor: false
  })
  ...
  useEffect(() => {
    const savedSettings = localStorage.getItem("simpleUserSettings")
    if (savedSettings) {
  ...
  const handleSave = () => {
    ...
    setTimeout(() => {
      try {
        localStorage.setItem("simpleUserSettings", JSON.stringify(settingsToSave))
        setIsSaving(false)
        toast({
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <Card className="mb-6 border-primary/20 bg-primary/5">
            <CardHeader>
              ...
              <CardDescription>
                Passen Sie die grundlegenden KI-Funktionen an
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Einfache Vorschläge für Ihre Reflexionen
                  </p>
                </div>
                <Switch
              ...
              <div className="space-y-4">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Einfache Einstellung der KI-Unterstützung
                </p>
                <Slider
